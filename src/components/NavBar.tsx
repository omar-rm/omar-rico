const NavBar = () => {
  return (
    <>
      <div className="fixed h-20 top-0 left-0 w-full flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 transition-all duration-500 z-50 bg-[#121212] ">
        ...
        {/* Menu links  */}
        <div className=" sm:flex md:flex items-center gap-2 lg:gap-8 w-2/4 justify-between px-7 mx-10 h-10  box rounded-full overflow-hidden">
